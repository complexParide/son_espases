...
- The dataset from the hospital of Son Espases that covers all entries from December 26th 2015 to December 31st 2022. The version uploaded is not the raw one but a clean and aggregated version. The dataset is split into the following files: *Y_train.csv* (training dataset), *Y_validation.csv* (validation dataset), *Y_test.csv* (test dataset), and *Y_post-covid.csv* (post-COVID dataset). Additional details can be found in the paper.
...
To access the raw data, please contact PUT_ROLE (PUT_EMAIL)
